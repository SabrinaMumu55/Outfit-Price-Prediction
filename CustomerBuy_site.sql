...
CREATE OR REPLACE PACKAGE BODY output AS
	...
	begin
	for r in (select pname from product1 join details1 on product1.pid= details1.pid where cid=CustomerID)
	loop 
...
BEGIN
	...
	select DISTINCT cid into CustomerID from Customer1 where cid= CustomerID;
